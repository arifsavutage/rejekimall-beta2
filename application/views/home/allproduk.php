		...
		?>
			<div class="large-3 medium-6 small-12 columns text-center">
				<ul class="pricing-table" data-equalizer-watch>
					<li class="large-12 medium-12 small-12 columns" style="min-width:170px;min-height:170px;">
						<a href="<?php echo base_url().'produk/detail/'.$randlist['gid'];?>">
						<img width="75" height="125" src="<?php echo base_url();?>asset/img/seller/produk/<?php echo $randlist['gambar'];?>">
						</a>
					</li>       
					<li>
						<p class="description">
