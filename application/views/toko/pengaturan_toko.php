				          ...
				          <form name="" id="" action="<?php echo base_url().'index.php/crud/simpan_produk' ?>" method="post">
					           <div class="row">
					            <div class="large-7 medium-12 small-12 columns">
					              <label>Nama Seller
					                <input type="text" placeholder="" name="nama_seller" />
					              </label>
					            </div>            
					          </div>
					          ...
					          <div class="row">
					            <div class="large-7 medium-12 small-12 columns">
					              <label>Slogan
					                <textarea name="slogan" placeholder=""></textarea>
					              </label>
					            </div>            
					          </div>
					          <div class="row">
					            <div class="large-7 medium-12 small-12 columns">
					              <label>Gambar Profil</label>
					              	<img src="<?php echo base_url().'img/seller2.jpg';?>" style="max-height:150px;border:solid 6px #FFFFFF;">
					                <input type="file" placeholder="" name="profil" />
					          ...
					          <div class="row">
					            <div class="large-7 medium-12 small-12 columns">
					              <label>Sampul Toko
					              	<img src="<?php echo base_url().'img/etalase.jpg';?>">
					                <input type="file" placeholder="" name="sampul" />
					              </label>
					            </div>            
					          </div>         
					          ...
					          <div class="row">
					            <div class="large-7 medium-12 small-12 columns">             
					                <input type="submit" placeholder="" class="alert button" value="Simpan"/>             
					            </div>            
					          </div>
			          	</form>
			          </div>
